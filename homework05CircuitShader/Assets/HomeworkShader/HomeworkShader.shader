...
Shader "HomeworkShader/YangBinShader"
{
	Properties{
		_Tint("Tint", Color)=(1,1,1,1)//颜色不支持"white"{}语法
		_CircuitTint("CircuitTint", Color) = (1,1,1,1)//颜色不支持"white"{}语法
		_Circuit("_Circuit",Float) = 1
		//主纹理系列
		_MainTex("Albedo",2D)="white"{}//纹理才支持
		[NoScaleOffset]_MSO("MetallicSmoothnessOcclusion",2D)="white"{}
		[NoScaleOffset]_NormalTex("Normal",2D)="white"{}
		_Bumpiness("Bumpiness",Float) = 1
		[NoScaleOffset]_Emission("Emission",2D) = "black"{}
		_Eminess("Eminess",Float) =1
